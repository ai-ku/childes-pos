...
as frame elements while the middle one is the target word that is categorized.
The correct grammatical category of target words are extracted from CHILDES.
[!! put number of target words table] 
