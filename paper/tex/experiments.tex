...
$aX+Xb$ and $a*b$ models on each child corpus.  The $a*b$ model significantly
outperforms the $aX+Xb$ model on each child corpora.[add lambda values]
\input{framevssub10K}
...
%%labeling for both models in Figure~\ref{fig:category10Kvs100K}.
%%\begin{figure}[h]
%%  \subfigure[$aX+Xb$ model with $10K$ iterations] {
%%    \includegraphics[width=0.5\textwidth]{../figures/fletags10K.pdf}
%%    \label{fig:subfig1}
%%  }
%%  \subfigure[$a*b$ model with $10K$ iterations] {
